...
export default function TreatmentsContent() {
 ...
 <p className="text-gray-500 text-[15px] leading-relaxed font-sans mb-3">
 ...
 <p className="text-gray-500 text-[15px] leading-relaxed font-sans mb-5">
 ...
 <div
 key={factor.label}
 className="bg-zen-mist/50 border border-sage-light/60 rounded-xl px-4 py-3 flex items-start gap-3"
 >
 <span className={`w-10 h-10 rounded-[10px] flex items-center justify-center text-lg shrink-0 ${factor.colorClass}`}>
 {factor.icon}
 </span>
 <div className="flex-1 min-w-0">
 <div className="font-semibold text-sm text-gray-900 font-sans">
 {factor.label}
 </div>
 ...
 <span className="text-[13px] font-bold text-moss shrink-0 font-sans">
 {factor.weight}
 </span>
 </div>
 ))}
 ...
 <p className="text-xs tracking-[0.3em] uppercase mb-2 text-moss font-sans font-semibold">
 Treatment Index
 </p>
 <h2 className="font-serif text-2xl md:text-[32px] text-gray-900">
 Every Modality, Ranked
 </h2>
 <p className="text-gray-500 text-[15px] mt-2 font-sans">
 ...
 className="flex-1 min-w-[200px] bg-white border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-sage/60 focus:ring-1 focus:ring-sage/20 font-sans"
 />
 <ViewToggle mode={viewMode} onChange={setViewMode} />
 <select
 value={sortBy}
 onChange={(e) => setSortBy(e.target.value as SortOption)}
 className="px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-[13px] text-gray-500 font-sans cursor-pointer outline-none shrink-0"
 >
