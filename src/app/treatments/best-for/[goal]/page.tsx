...
export default async function BestForGoalPage({ params }: Props) {
 ...
 className="inline-block text-sm text-gray-500 hover:text-moss transition-colors font-sans border border-gray-200 rounded-lg px-6 py-3 hover:border-sage/40"
 >
 ...
 <h2 className="font-serif text-xl md:text-2xl text-gray-900 mb-6">
 Also Explore
 </h2>
 ...
 className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white border border-gray-200 hover:border-sage/40 hover:shadow-md transition-all text-center"
 >
