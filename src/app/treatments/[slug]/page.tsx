...
export default async function TreatmentDetailPage({ params }: Props) {
 ...
 <p className="text-xs text-moss uppercase tracking-wider font-semibold font-sans mb-6">
 ...
 >
 <div className="text-[11px] text-gray-400 uppercase tracking-wider font-semibold font-sans mb-1.5">
 {protocol.label}
 </div>
 <div className="text-[15px] font-semibold text-gray-900 font-sans">
 {protocol.dosage}
 </div>
 ...
 className="bg-white border border-gray-200 rounded-xl p-4 hover:border-sage/40 transition-all"
 >
 ...
 <div className="text-xs text-moss font-sans mt-2">
 View details &rarr;
 </div>
 </Link>
 ))}
 ...
 <Link
 href="/explore"
 className="inline-block mt-4 text-sm text-moss hover:text-forest transition-colors font-sans"
 >
 ...
 <div className="text-[11px] text-gray-400 uppercase tracking-wide font-sans mt-0.5">
 {r.category}
 </div>
 </div>
 </Link>
