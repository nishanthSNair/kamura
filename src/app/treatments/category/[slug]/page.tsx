...
export default async function CategoryPage({ params }: Props) {
 ...
 className="group bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-sage/40 hover:shadow-lg transition-all"
 >
 ...
 <h3 className="font-semibold text-[15px] text-gray-900 font-sans truncate">
 {t.name}
 </h3>
 {t.fullName !== t.name && (
 ...
 <p className="text-xs text-gray-500 font-sans leading-relaxed mb-3 line-clamp-2">
 {t.description}
 </p>
