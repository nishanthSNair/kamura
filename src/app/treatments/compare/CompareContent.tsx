              ...
              {t && (
                <div className="mt-3 flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-semibold text-gray-900 dark:text-gray-100 font-sans">
                      {t.name}
                    </p>
        ...
        {hasSelections && (
          <>
            <div className="hidden md:block border border-gray-200 dark:border-white/[0.06] rounded-xl overflow-hidden">
              {/* Header Row */}
              <div className="grid grid-cols-[200px_1fr_1fr] border-b border-gray-200 dark:border-white/[0.06]">
                <div className="p-4 bg-gray-50 dark:bg-gray-800/50" />
                {[t1, t2].map((t, i) => (
                  <div
                    key={i}
                    className="p-4 bg-gray-50 dark:bg-gray-800/50 border-l border-gray-200 dark:border-white/[0.06]"
                  >
                    {t ? (
                      <Link
              ...
              {rows.map((row) => {
                ...
                return (
                  <div
                    key={row.label}
                    className="grid grid-cols-[200px_1fr_1fr] border-b border-gray-100 dark:border-white/[0.04] last:border-b-0"
                  >
                    ...
                    {[t1, t2].map((t, i) => (
                      <div
                        key={i}
                        className={`p-4 text-sm font-sans text-gray-800 dark:text-gray-200 border-l border-gray-100 dark:border-white/[0.04] ${i === 0 ? c1 : c2}`}
                      >
                        {t ? row.getValue(t) : "\u2014"}
                      </div>
                    ))}
              ...
              {/* Outcomes */}
              {hasBoth && (
                <div className="grid grid-cols-[200px_1fr_1fr] border-t border-gray-200 dark:border-white/[0.06]">
                  <div className="p-4 bg-gray-50/50 dark:bg-gray-900/50 font-sans text-sm text-gray-500 dark:text-gray-400 font-medium">
                    Key Outcomes
                  </div>
                  {[t1, t2].map((t, i) => (
                    <div
                      key={i}
                      className="p-4 border-l border-gray-100 dark:border-white/[0.04]"
                    >
                      {t && (
                                ...
                                <span
                                  className={`text-xs font-sans ${
                                    sharedOutcomes.includes(o.name)
                                      ? "text-moss dark:text-sage font-medium"
...
function ScoreBar({ value }: { value: number }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-xs font-sans font-medium text-gray-600 dark:text-gray-400 tabular-nums">
        {value}
      </span>
    </div>
  );
