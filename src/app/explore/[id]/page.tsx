...
export default async function ListingPage({ params }: Props) {
 ...
 <h1 className="font-serif text-3xl md:text-5xl text-gray-900 leading-tight mb-3">
 {listing.name}
 </h1>
 ...
 {/* Location */}
 <div className="flex items-center gap-2 text-sm text-gray-600 font-sans mb-8">
 ...
 <h2 className="font-serif text-xl text-gray-900 mb-4">Services & Treatments</h2>
 <div className="flex flex-wrap gap-2">
 {listing.services.map((service) => (
 <span
 key={service}
 className="px-3 py-1.5 text-sm font-sans rounded-full border border-gray-200 text-gray-700 bg-gray-50"
 >
 {service}
 </span>
 ))}
 ...
 <p className="text-xs text-gray-400 uppercase tracking-wider font-sans mb-1">Price Range</p>
 <p className="font-sans text-gray-900">{listing.priceRange}</p>
 </div>
 )}
 {listing.hours && (
 <div className="border border-gray-200 rounded-xl p-5">
 <p className="text-xs text-gray-400 uppercase tracking-wider font-sans mb-1">Hours</p>
 <p className="font-sans text-gray-900">{listing.hours}</p>
 </div>
 )}
 {listing.phone && (
 <div className="border border-gray-200 rounded-xl p-5">
 <p className="text-xs text-gray-400 uppercase tracking-wider font-sans mb-1">Phone</p>
 <p className="font-sans text-gray-900">{listing.phone}</p>
 </div>
 )}
 </div>
 </section>
 ...
 className="inline-flex items-center gap-2 bg-gray-900 text-white px-6 py-3 text-sm tracking-[0.1em] uppercase hover:bg-terracotta transition-colors font-sans"
 >
 Visit Website
 ...
 className="inline-flex items-center gap-2 border border-gray-300 text-gray-700 px-6 py-3 text-sm tracking-[0.1em] uppercase hover:border-terracotta hover:text-terracotta transition-colors font-sans"
 >
 ...
 {/* Google Maps */}
 <section className="max-w-3xl mx-auto px-6 pb-10">
 <h2 className="font-serif text-xl text-gray-900 mb-4">Location</h2>
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="inline-flex items-center gap-1.5 text-sm text-gray-600 hover:text-terracotta transition-colors font-sans mt-3"
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
 <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" />
 </svg>
 ...
 <section className="max-w-3xl mx-auto px-6 pb-10">
 <h2 className="font-serif text-xl text-gray-900 mb-4">Related Articles</h2>
 ...
 >
 <p className="text-xs text-gray-400 font-sans mb-1 uppercase tracking-wide">
 {post.category}
 </p>
 <h3 className="font-serif text-lg text-gray-900 mb-1 hover:text-terracotta transition-colors">
 {post.title}
 </h3>
 ...
 {/* Claim This Listing */}
 <section className="max-w-3xl mx-auto px-6 pb-10">
 <div className="border border-dashed border-gray-300 rounded-xl p-8 bg-gray-50/50 text-center">
 <h3 className="font-serif text-xl text-gray-900 mb-2">
 Is this your business?
 </h3>
 <p className="text-sm text-gray-500 font-sans leading-relaxed mb-5 max-w-md mx-auto">
 ...
 className="inline-flex items-center gap-2 bg-gray-900 text-white px-6 py-2.5 text-sm tracking-[0.1em] uppercase hover:bg-terracotta transition-colors font-sans"
 >
 Claim This Listing
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
 ...
 <h3 className="font-serif text-2xl text-gray-900 mb-2 text-center">
 ...
 <h4 className="font-serif text-lg text-gray-900 leading-snug mb-1">
 {related.name}
 </h4>
 <p className="text-sm text-terracotta font-sans mb-2">
 {related.tagline}
 </p>
 <p className="text-sm text-gray-500 font-sans leading-relaxed mb-3 flex-1 line-clamp-2">
 {related.description}
 </p>
