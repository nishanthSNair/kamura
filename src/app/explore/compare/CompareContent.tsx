...
export default function CompareContent() {
 ...
 <button
 onClick={addSlot}
 className="text-sm text-gray-500 hover:text-terracotta transition-colors font-sans border border-dashed border-gray-300 rounded-lg px-6 py-3 hover:border-terracotta"
 >
 ...
 {/* Header Row */}
 <div
 className={`grid border-b border-gray-200 ${selected.length === 3 ? "grid-cols-[160px_1fr_1fr_1fr]" : "grid-cols-[160px_1fr_1fr]"}`}
 >
 ...
 <div
 key={field.label}
 className={`grid border-b border-gray-100 last:border-b-0 ${selected.length === 3 ? "grid-cols-[160px_1fr_1fr_1fr]" : "grid-cols-[160px_1fr_1fr]"}`}
 >
 ...
 <div
 key={i}
 className="p-4 text-sm font-sans text-gray-800 border-l border-gray-100"
 >
 {l ? field.getValue(l) : "—"}
 </div>
 ))}
 ...
 {/* Action Row */}
 <div
 className={`grid border-t border-gray-200 ${selected.length === 3 ? "grid-cols-[160px_1fr_1fr_1fr]" : "grid-cols-[160px_1fr_1fr]"}`}
 >
 <div className="p-4 bg-gray-50/50 font-sans text-sm text-gray-500 font-medium">
 Details
 </div>
