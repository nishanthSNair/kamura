...
export default async function AreaPage({ params }: Props) {
 ...
 <p className="text-gray-500 font-sans leading-relaxed max-w-3xl">
 {area.description}
 </p>
 ...
 className="px-4 py-2 text-sm font-sans rounded-full border border-gray-200 text-gray-600 hover:border-terracotta hover:text-terracotta transition-colors"
 >
 {a.name}
 </Link>
 ))}
