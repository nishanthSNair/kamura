      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-8 px-6 py-3.5 rounded-full bg-[#173C3B] text-white text-xs tracking-[0.15em] uppercase font-semibold font-sans hover:bg-[#173C3B] transition-colors disabled:opacity-50"
          >
