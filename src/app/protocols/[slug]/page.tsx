...
function SectionCard({
  ...
  return (
    <section
      id={id}
      className="bg-white dark:bg-[#1C1815] border border-gray-200 dark:border-white/[0.06] rounded-2xl p-6 md:p-8 scroll-mt-24"
    >
    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-10 space-y-8">
        ...
        <SectionCard title="Overview" icon="📖" id="overview">
          <p className="text-sm text-gray-600 dark:text-[#A89F90] font-sans leading-relaxed mb-6">
            {p.description}
          </p>
          <h3 className="text-sm font-semibold text-gray-900 dark:text-[#F0EBE2] font-sans mb-3 uppercase tracking-wider">
            Key Principles
          </h3>
          <ul className="space-y-2">
            {p.keyPrinciples.map((principle, i) => (
              <li
                key={i}
                className="flex items-start gap-3 text-sm text-gray-600 dark:text-[#A89F90] font-sans"
              >
            ...
            <table className="w-full text-sm font-sans">
              <thead>
                <tr className="border-b border-gray-200 dark:border-white/[0.06]">
                  <th className="text-left py-2 pr-4 text-[11px] uppercase tracking-wider text-gray-400 dark:text-[#6B6358] font-semibold">
                    Supplement
                  </th>
                  <th className="text-left py-2 pr-4 text-[11px] uppercase tracking-wider text-gray-400 dark:text-[#6B6358] font-semibold">
                    Dose
                  </th>
                  <th className="text-left py-2 pr-4 text-[11px] uppercase tracking-wider text-gray-400 dark:text-[#6B6358] font-semibold hidden md:table-cell">
                    Timing
                  </th>
                  <th className="text-left py-2 text-[11px] uppercase tracking-wider text-gray-400 dark:text-[#6B6358] font-semibold hidden lg:table-cell">
                    Purpose
                  </th>
                </tr>
              </thead>
              <tbody>
                {p.supplements.map((s, i) => (
                  ...
                  >
                    <td className="py-2.5 pr-4 font-medium text-gray-900 dark:text-[#F0EBE2]">
                      {s.name}
                    </td>
                    <td className="py-2.5 pr-4 text-gray-600 dark:text-[#A89F90]">
                      {s.dose}
                    </td>
                    <td className="py-2.5 pr-4 text-gray-500 dark:text-[#6B6358] hidden md:table-cell">
                      {s.timing}
                    </td>
                    <td className="py-2.5 text-gray-500 dark:text-[#6B6358] hidden lg:table-cell text-xs">
                      {s.purpose}
                    </td>
                  </tr>
                ))}
            ...
            {p.exercises.map((e, i) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[10px] text-gray-400 dark:text-[#6B6358] font-sans uppercase">
                    {e.frequency}
                  </span>
                </div>
                ...
                <p className="text-xs text-gray-500 dark:text-[#A89F90] font-sans leading-relaxed">
                  {e.details}
                </p>
              </div>
            ))}
        ...
        <SectionCard title="Key Results & Claims" icon="📊" id="results">
          ...
          <p className="text-[11px] text-gray-400 dark:text-[#6B6358] font-sans italic mt-4">
                  ...
                  t && (
                    ...
                    >
                      ...
                      <div className="p-2.5 text-center">
                        <div className="font-semibold text-xs text-gray-900 dark:text-[#F0EBE2] font-sans">
                          {t.name}
                        </div>
                        <div className="text-[10px] text-gray-400 dark:text-[#6B6358] uppercase tracking-wide font-sans mt-0.5">
                          Score: {t.kamuraScore}
                        </div>
                      </div>
                    </Link>
        ...
        {otherProtocols.length > 0 && (
          <section className="border-t border-gray-200 dark:border-white/[0.06] pt-10">
            <h2 className="font-serif text-xl text-gray-900 dark:text-[#F0EBE2] mb-5">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {otherProtocols.map((o) => (
                <Link
                  ...
                  className="bg-white dark:bg-[#1C1815] border border-gray-200 dark:border-white/[0.06] rounded-xl p-5 hover:border-sage/40 transition-all"
                >
                  <h3 className="font-serif text-base text-gray-900 dark:text-[#F0EBE2] mb-1">
                    {o.name}
                  </h3>
                  <p className="text-xs text-gray-500 dark:text-[#A89F90] font-sans mb-2">
                    by {o.creator}
                  </p>
                  <p className="text-xs text-gray-400 dark:text-[#6B6358] font-sans line-clamp-2">
                    {o.tagline}
                  </p>
                </Link>
              ))}
        ...
        <section className="scroll-mt-24">
          <div className="border border-sage-light/60 dark:border-forest/20 rounded-xl p-6 bg-zen-mist/50 dark:bg-forest/5">
            <p className="text-xs text-gray-400 dark:text-[#6B6358] font-sans leading-relaxed">
              <strong className="text-gray-500 dark:text-[#A89F90]">
                Disclaimer:
              </strong>{" "}
