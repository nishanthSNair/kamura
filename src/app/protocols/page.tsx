    ...
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {protocols.map((p) => (
            <Link
              ...
              className="group bg-white dark:bg-[#1C1815] border border-gray-200 dark:border-white/[0.06] rounded-2xl overflow-hidden hover:border-sage/40 hover:shadow-lg transition-all"
            >
              {/* Image */}
              ...
              <div className="p-5 md:p-6">
                <p className="text-sm text-gray-600 dark:text-[#A89F90] font-sans leading-relaxed line-clamp-3 mb-4">
                  {p.tagline}
                </p>

                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-2.5 py-1 rounded-lg text-[11px] font-medium bg-gray-100 dark:bg-white/[0.04] text-gray-600 dark:text-[#A89F90] font-sans">
                    {p.monthlyCost}
                  </span>
                  <span className="px-2.5 py-1 rounded-lg text-[11px] font-medium bg-gray-100 dark:bg-white/[0.04] text-gray-600 dark:text-[#A89F90] font-sans">
                    {p.timeCommitment}
                ...
                <div className="flex flex-wrap gap-1.5">
                  {p.tags.slice(0, 4).map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-0.5 rounded-full text-[10px] text-gray-400 dark:text-[#6B6358] border border-gray-200 dark:border-white/[0.06] font-sans"
                    >
                      {tag}
                    </span>
                  ))}
      ...
      <section className="border-t border-gray-200 dark:border-white/[0.06]">
        <div className="max-w-[1200px] mx-auto px-6 py-12 text-center">
          <h2 className="font-serif text-xl md:text-2xl text-gray-900 dark:text-gray-100 mb-3">
            Explore Individual Treatments
          </h2>
          <p className="text-sm text-gray-500 dark:text-[#A89F90] font-sans mb-6 max-w-[500px] mx-auto">
