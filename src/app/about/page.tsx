        ...
        <FadeInOnScroll className="max-w-2xl mx-auto px-6 py-20 md:py-28">
          <div className="space-y-12">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed font-sans mt-4">
            ...
            <div>
              ...
              <div className="space-y-5">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-sans font-medium text-gray-800 dark:text-gray-200 mb-1">Transparency over marketing</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-sans">Every treatment on Kamura is scored with real data — research quality, safety profile, and community experience. No paid placements.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-1 bg-sage/40 rounded-full shrink-0" />
                  <div>
                    <p className="font-sans font-medium text-gray-800 dark:text-gray-200 mb-1">Evidence meets experience</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-sans">We balance clinical research with real community reports. Science matters, but so does what actually works for people.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-1 bg-sage/40 rounded-full shrink-0" />
                  <div>
                    <p className="font-sans font-medium text-gray-800 dark:text-gray-200 mb-1">Longevity is a practice, not a product</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-sans">There are no shortcuts. The best longevity protocol is built on sleep, nutrition, movement, and community — everything else is a tool.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-5">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-moss dark:text-sage hover:text-forest dark:hover:text-white transition-colors font-sans font-medium"
                >
