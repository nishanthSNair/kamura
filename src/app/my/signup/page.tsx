...
export default function MemberSignupPage() {
  ...
  async function handleEmailSignup(e: React.FormEvent) {
    ...
    if (authData.user) {
      const { error: profileErr } = await supabase.rpc("create_member_profile", {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#EDE7DB] px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg border border-gray-200/60">
          <h1 className="font-serif text-2xl text-gray-900 mb-2">Create your account</h1>
          <p className="text-sm text-gray-500 font-sans mb-8">
            Track your protocols, book sessions, and build your wellness
            intelligence layer.
          </p>
          ...
          <p className="text-center text-sm text-gray-500 font-sans mt-6">
            ...
            <Link href="/my/login" className="text-terracotta hover:underline">
              Sign in
            </Link>
          </p>
        </div>
