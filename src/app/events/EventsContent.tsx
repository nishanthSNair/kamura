...
export default function EventsContent() {
 ...
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans">Events Tracked</p>
 </div>
 <div className="text-center">
 <p className="font-serif text-2xl text-emerald-700">{upcomingCount}</p>
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans">Upcoming</p>
 </div>
 <div className="text-center">
 <p className="font-serif text-2xl text-gray-900">{totalAttendees.toLocaleString()}+</p>
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans">Total Attendees</p>
 </div>
 <div className="text-center">
 <p className="font-serif text-2xl text-gray-900">{ALL_CATEGORIES.length}</p>
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans">Categories</p>
 </div>
 </div>
 </div>
 </section>
 ...
 className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl text-sm font-sans text-gray-800 placeholder-gray-400 bg-white focus:outline-none focus:border-sage/50 focus:ring-1 focus:ring-sage/20 transition-colors"
 />
 {searchQuery && (
 <button
 ...
 <div key={i} className="px-1 md:px-2 py-2 md:py-3 text-center text-[10px] md:text-xs font-sans uppercase tracking-wider text-gray-500">
 ...
 <div key={`empty-${i}`} className="h-14 md:h-24 border-b border-r border-gray-100" />
 ))}
 ...
 className={`h-14 md:h-24 border-b border-r border-gray-100 p-1 md:p-2 text-left transition-colors relative ${
 ...
 >
 <span className={`text-xs md:text-sm font-sans inline-flex items-center justify-center w-6 h-6 md:w-7 md:h-7 rounded-full ${isToday ? "bg-terracotta text-white" : "text-gray-700"}`}>
 {day}
 </span>
 {dayEvents.length > 0 && (
 ...
 <section className="border-t border-gray-100 bg-zen-mist/30">
 <div className="max-w-6xl mx-auto px-6 py-16">
 <p className="text-xs uppercase tracking-widest text-gray-400 font-sans mb-6 text-center">Explore KAMURA</p>
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
 <Link href="/treatments" className="block p-6 border border-gray-200 rounded-xl bg-white hover:border-terracotta/40 transition-colors text-center">
 <span className="text-3xl mb-2 block">🔬</span>
 <span className="font-serif text-lg text-gray-900 block mb-1">Browse Treatments</span>
 <span className="text-xs text-gray-500 font-sans">100+ treatments scored on evidence</span>
 </Link>
 <Link href="/wellness-checker" className="block p-6 border border-gray-200 rounded-xl bg-white hover:border-terracotta/40 transition-colors text-center">
 <span className="text-3xl mb-2 block">🩺</span>
 <span className="font-serif text-lg text-gray-900 block mb-1">Wellness Checker</span>
 <span className="text-xs text-gray-500 font-sans">Personalized treatment recommendations</span>
 </Link>
 <Link href="/explore" className="block p-6 border border-gray-200 rounded-xl bg-white hover:border-terracotta/40 transition-colors text-center">
 <span className="text-3xl mb-2 block">📍</span>
 <span className="font-serif text-lg text-gray-900 block mb-1">Find Clinics</span>
 <span className="text-xs text-gray-500 font-sans">70+ wellness centers in Dubai & UAE</span>
 </Link>
 </div>
 </div>
 </section>
...
function EventCard({
 ...
 <div>
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans mb-1">Attendees</p>
 <p className="text-sm font-sans text-gray-800">{event.attendees}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans mb-1">Speakers</p>
 <p className="text-sm font-sans text-gray-800">{event.speakers}</p>
 </div>
 <div>
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans mb-1">Price</p>
 <p className="text-sm font-sans text-gray-800">{event.price}</p>
 </div>
 </div>
 <div className="mb-5">
 <p className="text-xs text-gray-500 uppercase tracking-wider font-sans mb-2">Key Highlights</p>
