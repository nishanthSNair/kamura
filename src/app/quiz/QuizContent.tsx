        ...
        <section className="max-w-4xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <h3 className="font-serif text-lg text-gray-900 dark:text-gray-100 mb-2">Your Wellness Score</h3>
            ...
            <div>
              ...
              <h3 className="font-serif text-lg text-gray-900 dark:text-gray-100 mb-2">Your Wellness Archetype</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-sans">
            ...
            <div>
              ...
              <h3 className="font-serif text-lg text-gray-900 dark:text-gray-100 mb-2">Where to Start</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-sans">
    ...
    return (
      <section className="min-h-screen bg-white dark:bg-[#1C1815] pt-24 pb-20 zen-pattern">
        <div className="max-w-2xl mx-auto px-6">
          ...
          {/* Dimension Badge */}
          <span className="inline-block text-xs px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 font-sans mb-4">
          ...
          <h2
            key={q.id}
            className="font-serif text-2xl md:text-3xl text-gray-900 dark:text-gray-100 leading-snug mb-10 animate-fade-in"
          >
            {q.question}
          </h2>
      ...
      <>
        ...
        <section className="pt-28 pb-16 px-6">
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xs tracking-[0.3em] uppercase mb-6 text-gray-400 dark:text-gray-500">
              Your Results
            </p>
            ...
            <div className="relative w-40 h-40 mx-auto mb-8">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-3xl font-serif text-gray-900 dark:text-gray-100">
        ...
        <section className="max-w-2xl mx-auto px-6 pb-16">
          <div className={`rounded-xl border ${primary.color.border} ${primary.color.bg} p-8 mb-6`}>
            <p className="text-xs tracking-[0.3em] uppercase mb-3 text-gray-400 dark:text-gray-500 font-sans">
              Your Wellness Archetype
            </p>
            <h2 className={`font-serif text-3xl ${primary.color.text} mb-2`}>
              {primary.name}
            </h2>
            <p className="font-serif text-lg text-gray-600 dark:text-gray-400 italic mb-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 font-sans text-center">
            ...
            {results.dimensionAverages.map(({ dimension, score }) => (
              <div key={dimension}>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-sm font-sans text-gray-400 dark:text-gray-500">{score}%</span>
                </div>
        ...
        <section className="max-w-2xl mx-auto px-6 pb-16">
          <h3 className="font-serif text-2xl text-gray-900 dark:text-gray-100 mb-2">
              ...
              >
                ...
                <ul className="space-y-2">
                  {week.steps.map((step, si) => (
                    <li key={si} className="flex gap-3 text-sm text-gray-600 dark:text-gray-400 font-sans">
                      <span className={`mt-1 w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${wi === 0 ? primary.color.border : "border-gray-200 dark:border-gray-700"}`}>
                        <span className="text-xs text-gray-400 dark:text-gray-500">{si + 1}</span>
                      </span>
                      {step}
                    </li>
                  ))}
          ...
          <div className="max-w-2xl mx-auto px-6 py-16 text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center mb-10">
              <button
                ...
                className="px-6 py-3 border border-gray-200 dark:border-gray-700 text-sm font-sans text-gray-700 dark:text-gray-300 hover:border-gray-400 transition-colors rounded-lg flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-6 py-3 border border-gray-200 dark:border-gray-700 text-sm font-sans text-gray-700 dark:text-gray-300 hover:border-gray-400 transition-colors rounded-lg"
              >
                Post on X
              </button>
              <button
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                onClick={startQuiz}
                className="px-6 py-3 border border-gray-200 dark:border-gray-700 text-sm tracking-[0.1em] uppercase text-gray-700 dark:text-gray-300 hover:border-gray-400 transition-colors font-sans rounded-lg"
              >
                Retake Quiz
              </button>
              <Link
