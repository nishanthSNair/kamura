    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
      {categories.map((cat) => (
        <Link
          ...
          className="group border border-gray-200 dark:border-white/[0.06] rounded-xl p-4 text-center hover:border-kamura-gold/40 hover:bg-kamura-gold/5 transition-all"
        >
