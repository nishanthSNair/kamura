      ...
      <div className="fixed left-4 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-2">
        <div className="flex flex-col gap-1.5 bg-white/90 dark:bg-[#1C1815]/90 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-2xl p-2 shadow-lg shadow-black/5">
          ...
          <div className="relative">
            ...
            {igCopied && (
              <span className="absolute left-12 top-1/2 -translate-y-1/2 px-2.5 py-1.5 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-[11px] rounded-lg font-sans whitespace-nowrap pointer-events-none shadow-lg">
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <div className="relative">
        ...
        {igCopied && (
          <span className="absolute -top-9 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-[10px] rounded-lg font-sans whitespace-nowrap pointer-events-none shadow-lg">
            Paste in Story!
          </span>
        )}
      </div>
      ...
      <div className="relative">
        ...
        {copied && (
          <span className="absolute -top-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-[11px] rounded-lg font-sans whitespace-nowrap pointer-events-none shadow-lg">
            Copied!
          </span>
        )}
      </div>
