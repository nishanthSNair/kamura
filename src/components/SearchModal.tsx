...
export default function SearchModal({ isOpen, onClose }: SearchModalProps) {
 ...
 >
 <div
 className="max-w-2xl mx-auto mt-12 md:mt-24 mx-4 md:mx-auto bg-white rounded-xl shadow-2xl overflow-hidden"
 ...
 className="flex-1 text-sm font-sans text-gray-800 placeholder-gray-400 outline-none bg-transparent"
