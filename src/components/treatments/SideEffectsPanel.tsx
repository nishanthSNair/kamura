...
const severityConfig = [
  {
    ...
    label: "Common",
    dotColor: "bg-[#4ADE80]",
    pillBg: "bg-[#16A34A]/8 dark:bg-[#4ADE80]/8",
    pillText: "text-[#16A34A] dark:text-[#4ADE80]",
    pillBorder: "border-[#16A34A]/15 dark:border-[#4ADE80]/15",
  },
  {
    key: "rare" as const,
    label: "Rare",
    dotColor: "bg-[#FACC15]",
    pillBg: "bg-[#CA8A04]/8 dark:bg-[#FACC15]/8",
    pillText: "text-[#CA8A04] dark:text-[#FACC15]",
    pillBorder: "border-[#CA8A04]/15 dark:border-[#FACC15]/15",
  },
  {
    key: "serious" as const,
    label: "Serious",
    dotColor: "bg-[#F87171]",
    pillBg: "bg-[#DC2626]/8 dark:bg-[#F87171]/8",
    pillText: "text-[#DC2626] dark:text-[#F87171]",
    pillBorder: "border-[#DC2626]/15 dark:border-[#F87171]/15",
  },
];
