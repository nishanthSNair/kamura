      ...
      <div className="bg-[#EA580C]/[0.03] dark:bg-[#FB923C]/[0.03] border border-[#EA580C]/15 dark:border-[#FB923C]/15 rounded-2xl p-8 md:p-10">
        ...
        {hasInteractions && (
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            {interactions.drugs.length > 0 && (
              <div>
                <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider font-sans mb-2">
                  Drug Interactions
                </h3>
        ...
        {hasContraindications && (
          <div className={hasInteractions ? "pt-5 border-t border-[#EA580C]/10 dark:border-[#FB923C]/10" : ""}>
            <h3 className="text-xs font-semibold text-[#EA580C] dark:text-[#FB923C] uppercase tracking-wider font-sans mb-3 flex items-center gap-1.5">
