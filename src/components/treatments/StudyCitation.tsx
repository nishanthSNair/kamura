        ...
        <div className="min-w-0">
          ...
          {study.pmid && (
            <a
              ...
              className="inline-flex items-center gap-1 text-xs text-moss dark:text-sage hover:text-forest dark:hover:text-sage-dark transition-colors font-sans mt-2"
            >
              View on PubMed
