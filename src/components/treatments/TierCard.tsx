...
export default function TierCard({ treatment: t, tier }: TierCardProps) {
 return (
 <div className="group relative bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-sage/40 hover:shadow-lg transition-all">
 ...
 <h4 className="font-semibold text-sm text-gray-900 font-sans leading-tight line-clamp-1">
 {t.name}
 </h4>
 </div>
 <p className="text-[11px] text-gray-500 font-sans line-clamp-2 leading-relaxed mb-2.5">
 {t.description}
 </p>
