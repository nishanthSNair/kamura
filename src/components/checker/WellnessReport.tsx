    ...
    <div className="min-h-screen px-6 pt-24 pb-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            <button
              ...
              className="px-4 py-2 text-sm font-sans text-terracotta dark:text-[#C4A882] border border-terracotta/30 dark:border-[#C4A882]/30 rounded-full hover:bg-terracotta/5 transition-colors"
            >
              + Add another area
            </button>
            <button
              onClick={onRestart}
              className="px-4 py-2 text-sm font-sans text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
            >
              Start over
            </button>
          </div>
        ...
        <section className="mb-12">
          <h2 className="font-serif text-xl md:text-2xl text-gray-900 dark:text-[#F0EBE2] mb-1">
            Understanding Your Concerns
          </h2>
          <p className="text-sm text-gray-500 dark:text-[#6B6358] font-sans mb-5">
            ...
            <div className="space-y-3">
              ...
              {results.length > INITIAL_SHOW && (
                <details className="group">
                  <summary className="w-full py-3.5 mt-2 border border-gray-200 dark:border-white/[0.06] rounded-xl text-sm font-sans text-gray-600 dark:text-gray-400 hover:border-terracotta/40 hover:text-terracotta transition-all bg-white dark:bg-[#1C1815] cursor-pointer text-center list-none">
        ...
        <section className="border-t border-gray-200 dark:border-white/[0.06] pt-8">
          <div className="bg-amber-50/50 dark:bg-amber-500/[0.04] border border-amber-200/50 dark:border-amber-500/10 rounded-xl p-5">
            <p className="text-sm text-amber-800 dark:text-amber-300/80 font-sans leading-relaxed">
          ...
          <div className="flex flex-wrap gap-3 mt-6 justify-center">
            ...
            <button
              onClick={onRestart}
              className="px-6 py-3 text-sm font-sans text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 border border-gray-200 dark:border-white/[0.06] rounded-full transition-colors"
            >
              Start over
            </button>
          </div>
