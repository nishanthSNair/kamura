...
export default function InteractiveBody({
 ...
 {/* Headline */}
 <h1 className="font-serif text-3xl md:text-5xl text-gray-900 text-center mb-3">
 Where would you like to{" "}
 <em className="italic text-terracotta">feel better</em>?
 </h1>
 <p className="text-sm md:text-base text-gray-500 font-sans text-center mb-10 md:mb-14">
 ...
 : completed
 ? "text-sage-dark"
 : "text-gray-600 group-hover:text-terracotta"
 }`}
 >
 {completed && (
 ...
 y="50"
 textAnchor="middle"
 className="text-[14px] fill-sage-dark font-bold"
 >
 &#10003;
 </text>
 )}
 ...
 y="125"
 textAnchor="middle"
 className="text-[12px] fill-sage-dark font-bold"
 >
 &#10003;
 </text>
 )}
 ...
 : "border-gray-200 bg-white text-gray-700 hover:border-terracotta/40"
 }`}
 >
