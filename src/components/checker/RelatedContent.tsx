...
export default function RelatedContent({ posts }: RelatedContentProps) {
 ...
 key={post.slug}
 href={`/blog/${post.slug}`}
 className="group bg-white border border-gray-200 rounded-xl p-4 hover:border-terracotta/40 transition-colors"
 >
 ...
 <h4 className="font-serif text-sm text-gray-900 group-hover:text-terracotta transition-colors leading-snug mb-1.5">
 {post.title}
 </h4>
