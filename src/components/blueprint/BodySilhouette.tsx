...
export default function BodySilhouette({
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      {/* Tooltip */}
      {hoveredZone && (
        <div className="absolute top-2 left-1/2 -translate-x-1/2 z-20 px-3 py-2 rounded-lg bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/[0.06] shadow-lg max-w-[200px]">
