    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-white/[0.06] shadow-2xl p-8 animate-blueprint-fade-in">
        {saved ? (
          ...
          <>
            <h3 className="font-serif text-xl text-gray-900 dark:text-gray-100 mb-1">
              Save Your Blueprint
            </h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-sans mb-6">
            ...
            {/* Score summary */}
            <div className="bg-zen-mist/50 dark:bg-forest/10 rounded-xl p-4 mb-6">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-sans uppercase tracking-wider text-gray-500 dark:text-gray-400">
                  Blueprint Score
                </span>
                <span
            ...
            {/* Email input */}
            <div className="mb-4">
              <label className="block text-sm text-gray-600 dark:text-gray-300 font-sans mb-2">
                Email (optional)
              </label>
              <input
                type="email"
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-white/[0.06] bg-white dark:bg-[#141414] text-gray-900 dark:text-gray-100 font-sans focus:outline-none focus:border-terracotta transition-colors"
              />
            </div>
            ...
            <p className="text-[10px] text-gray-400 dark:text-gray-500 font-sans text-center mt-3">
