  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between mb-3">
        <span className="text-sm text-gray-600 dark:text-gray-300 font-sans">
          {label}
        </span>
      ...
      <input
        ...
        className="w-full blueprint-slider bg-gray-200 dark:bg-gray-700"
      />
        ...
        return (
          <div key="step-8" className="animate-blueprint-fade-in">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm text-gray-600 dark:text-gray-300 font-sans mb-3">
                  Alcohol consumption
                </label>
      ...
      case 9:
        return (
          <div key="step-9" className="animate-blueprint-fade-in">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 font-sans mt-3">
              {(answers.goals || []).length}/3 selected
            </p>
          </div>
        );
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="flex items-center justify-between mt-10">
          {step > 0 ? (
            <button
              onClick={onBack}
              className="text-sm text-gray-500 dark:text-gray-400 hover:text-moss transition-colors font-sans"
            >
              &larr; Back
            </button>
          ) : (
