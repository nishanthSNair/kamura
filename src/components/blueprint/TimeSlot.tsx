...
export default function TimeSlot({
 ...
 {/* Time label */}
 <span className="w-16 shrink-0 text-[11px] text-gray-400 font-sans pt-1 text-right">
 {formatHour(hour)}
 </span>
 ...
 <span
 key={id}
 className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-sage/10 border border-sage/20 text-xs font-sans text-gray-700"
 >
 <span>{t.emoji}</span>
