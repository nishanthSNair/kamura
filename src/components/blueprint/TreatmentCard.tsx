    ...
    >
      ...
      <div className="flex items-start gap-2.5 mb-2">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-[13px] font-sans font-semibold text-gray-900 dark:text-gray-100 leading-tight">
            {treatment.name}
          </h4>
          <div className="flex items-center gap-2 mt-0.5">
            <span className="text-[10px] text-gray-400 dark:text-gray-500 font-sans">
              {treatment.timeCost}
            </span>
        ...
        {sortedEffects.map(([key, value]) => {
          ...
          return (
            <div key={key} className="flex items-center gap-1.5">
              <span className="text-[9px] text-gray-400 dark:text-gray-500 font-sans w-12 truncate">
