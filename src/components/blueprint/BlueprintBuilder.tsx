  ...
  return (
    <section className="min-h-screen pt-20 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-serif text-xl md:text-2xl text-gray-900 dark:text-gray-100">
                Your Body Blueprint
              </h1>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-xs text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 font-sans transition-colors"
            >
              Start Over
            </button>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 mt-8">
        <p className="text-[10px] text-gray-400 dark:text-gray-500 font-sans text-center leading-relaxed">
