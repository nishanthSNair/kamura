  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#101910] to-[#0a0e0a] py-[180px] px-6 md:px-12 pb-20">
      ...
      >
        <defs>
          <linearGradient id="flowg" x1="0" x2="1" y1="0" y2="0">
            <stop offset="0%" stopColor="#DCEC8B" stopOpacity="0" />
            <stop offset="50%" stopColor="#DCEC8B" stopOpacity=".7" />
            <stop offset="100%" stopColor="#DCEC8B" stopOpacity="0" />
          </linearGradient>
        </defs>
      ...
      <div className="relative max-w-[1152px] mx-auto text-center">
        ...
        >
          Get <i className="italic text-[#DCEC8B]">discovered</i> on Kamura.
        </h2>
        ...
        <div className="inline-flex items-center gap-4.5 pl-6 pr-2.5 py-2.5 rounded-full bg-white/6 border border-[#DCEC8B]/25 backdrop-blur-xl text-[13.5px] text-white">
          <span>List your practice — it&rsquo;s free to join</span>
          <Link
            href="/list-your-business"
            className="inline-flex items-center gap-2 h-11 px-6 rounded-full bg-[#00786E] hover:bg-[#005E57] text-white font-medium transition-colors"
          >
