...
export default function StackFAB({ onClick }: StackFABProps) {
 ...
 <button
 onClick={onClick}
 className="fixed bottom-6 right-6 z-40 flex items-center gap-2.5 px-5 py-3 bg-[#00786E] hover:bg-[#005E57] text-white rounded-full shadow-xl transition-all hover:scale-105 font-sans"
 >
