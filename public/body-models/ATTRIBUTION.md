...
## Kamura adaptation — September 2026

Viewer adapted from [Human Atlas by ashemag](https://github.com/ashemag/human-atlas), MIT License. The original LICENSE is retained in this project. Kamura changes include interface styling, an educational journey, contextual source panels, eased camera focus, and reduced-motion handling. Source anatomical geometry is unchanged from the downloaded repository. Educational text added by Kamura links to NIDDK overviews and is distinct from the BodyParts3D geometry.
