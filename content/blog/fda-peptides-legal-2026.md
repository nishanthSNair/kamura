...
relatedTreatments: ["bpc-157", "tb-500", "ghk-cu", "epitalon", "mots-c", "semax", "kpv"]
...
faqItems:
  - question: "Are peptides legal again in 2026?"
    answer: "As of April 15, 2026, the FDA removed 12 peptides (including BPC-157, TB-500, GHK-Cu, Epitalon, MOTS-c, Semax, and KPV) from its Category 2 restricted list. They are not FDA-approved drugs, but they are no longer flagged as posing a significant safety concern under the 503A compounding framework. Final bulks-list decisions come from the Pharmacy Compounding Advisory Committee in July 2026 and early 2027."
  - question: "Which peptides did the FDA remove from Category 2 on April 15, 2026?"
    answer: "The twelve peptides removed are BPC-157, TB-500, Cathelicidin LL-37, Epitalon, GHK-Cu (injectable), MOTS-c, DSIP, Dihexa, PEG-MGF, Melanotan II, KPV, and Semax. The removal becomes effective seven days after publication."
  - question: "Does this mean my doctor can prescribe BPC-157 right now?"
    answer: "Not yet at full scale. Category 2 removal clears the regulatory block, but licensed compounding pharmacies typically wait for the Pharmacy Compounding Advisory Committee (PCAC) to recommend a substance for the 503A bulk drug substances list before preparing it at volume. BPC-157 and TB-500 are on the July 2026 agenda. Some pharmacies may move sooner; most will wait for PCAC."
  - question: "Does the FDA decision affect peptide access in the UAE?"
    answer: "Not directly. UAE peptide access is governed by MOHAP, DHA, and DOH, not the FDA. However, many UAE compounding pharmacies source active pharmaceutical ingredients from US and European manufacturers, so a more permissive US supply environment will ease sourcing, pricing, and documentation for UAE clinics."
  - question: "When does PCAC decide on BPC-157 and TB-500?"
    answer: "The Pharmacy Compounding Advisory Committee (PCAC) holds its first set of meetings on roughly half of the twelve peptides in July 2026, including BPC-157 and TB-500. The remainder are scheduled for review through early 2027. A PCAC recommendation is not final until the FDA formally accepts it."
  - question: "Why did the FDA reverse course on these peptides?"
    answer: "The reversal was triggered by the original nominators voluntarily withdrawing their Category 2 nominations, not by new safety data. This is a procedural reset rather than a scientific endorsement, which is why PCAC review in July 2026 is the more consequential event."
---

If you have spent the last three years watching the peptide world get pushed underground, this week was a turning point. On April 15, 2026, the FDA quietly published a notice that removes twelve peptides, including [BPC-157](/treatments/bpc-157), [TB-500](/treatments/tb-500), [GHK-Cu](/treatments/ghk-cu), and [Epitalon](/treatments/epitalon), from its Category 2 list of "significant safety concern" compounds.
...
- [BPC-157](/treatments/bpc-157)
- [TB-500](/treatments/tb-500)
- Cathelicidin LL-37
- [Epitalon](/treatments/epitalon)
- [GHK-Cu](/treatments/ghk-cu) (injectable)
- [MOTS-c](/treatments/mots-c)
- DSIP
- Dihexa
- PEG-MGF
- Melanotan II
- [KPV](/treatments/kpv)
- [Semax](/treatments/semax)

The removal becomes effective seven days after publication. As of this week, these twelve peptides are no longer flagged as posing a significant safety concern under the FDA's compounding framework. For a deeper breakdown of what each of these does and the evidence behind them, see our [complete 2026 peptide guide](/blog/peptide-therapy-complete-guide-2026).
...
New to the category and wondering where to start? Read our [Peptides 101 beginner's guide](/blog/peptides-101-beginners-guide-dubai) or visit the [Kamura peptide hub](/peptides) for the full picture.

## What this means for peptide access in Dubai and the UAE

The April 15 notice is a US action, but its consequences land in the UAE quickly. UAE peptide access is governed by MOHAP, DHA, and DOH, not the FDA, and licensed UAE clinics have been prescribing peptides like [BPC-157](/treatments/bpc-157), [CJC-1295/Ipamorelin](/treatments/cjc-1295-ipamorelin), and [Semaglutide](/treatments/semaglutide) through regulated compounding pharmacies throughout the US restriction window.
...
If you are a UAE patient, the practical takeaway is simple: access was already legal here. What is arriving now is better-sourced product and deeper clinical familiarity. Check our [peptide sourcing guide](/peptides/sourcing-guide) before committing to any protocol.
...
For ongoing coverage of PCAC decisions, study publications, and regulatory shifts as they happen, track the [Kamura evidence feed](/peptides/evidence-feed).
...
At Kamura, we cut through the noise. The [Peptide Intelligence Hub](/peptides) tracks Kamura Scores on every compound under review, evidence summaries you can trust, and a directory of practitioners credentialed to work with peptides under the new framework. July is going to be loud. We will be ready.

---

*Have a peptide-literate practice and want to be discoverable on Kamura when the rules change? [Join the practitioner directory](/list-your-business).*
